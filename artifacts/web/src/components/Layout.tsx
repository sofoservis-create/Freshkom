  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#20ba5a] text-white pl-4 pr-5 py-3 rounded-full shadow-2xl shadow-black/25 hover:shadow-[#25D366]/40 hover:scale-105 active:scale-95 transition-all duration-200 group"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-current flex-shrink-0">
