        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <Card className="h-full border-0 shadow-md rounded-2xl hover:shadow-lg transition-shadow text-center">
                  <CardContent className="p-6 flex flex-col items-center">
                    <div className={`h-14 w-14 rounded-2xl ${info.color} flex items-center justify-center mb-4`}>
                      <info.icon className="h-7 w-7" />
                    </div>
                    <h3 className="font-bold mb-1">{info.title}</h3>
                    {info.href ? (
                      <a href={info.href} className="text-primary hover:underline font-medium">
                        {info.value}
                      </a>
                    ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Nezáväzný dopyt</h2>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-3 p-4 bg-blue-50 rounded-2xl hover:bg-blue-100 transition-colors group"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-3 p-4 bg-pink-50 rounded-2xl hover:bg-pink-100 transition-colors group"
                >
